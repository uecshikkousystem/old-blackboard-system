...
<!--                          <input type="radio" name="faculty" id="faculty-e" value="E" <?php if (preg_match("/^re$/",$status)) { if (empty($_SESSION['error3']) && preg_match("/^E$/",$_SESSION['faculty'])){ echo "checked=\"checked\""; }} ?> onclick="ChangeSubject();" /><label for="faculty-e">電気通信学部・学域</label> -->
