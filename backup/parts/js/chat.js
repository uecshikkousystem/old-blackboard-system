...
function ChatCheck() {
	 ...
	 request.open("GET", "read.php?mode=listcheck&time=" + clear, true);
	 request.send(null);
...
function Chatload() {
	 ...
	 request.open("GET", "read.php?mode=listget&time=" + clear, true);
	 request.send(null);
	 request.onreadystatechange = readyStateChangeHandler;
...
function ChatConti() {
	 ...
	 var url = "read.php?mode=listconti&time=" + clear
